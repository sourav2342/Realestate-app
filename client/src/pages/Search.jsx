    ...
    <div className='flex flex-col md:flex-row'>
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center gap-2'>
                    ...
                    <input type="text" id='searchTerm' placeholder='Search...' onChange={handleChange} value={sidebardata.searchTerm} className='border rounded-lg p-3 w-full'/>
                </div>
        ...
        <div className='flex-1'>
            ...
            <div className='p-7 flex flex-wrap gap-4'>
                ...
                {showMore && (
                    <button onClick={onShowMoreClick} className='bg-green-700 hover:underline p-7 text-center w-full'>
                        show more
                    </button>
                )}
            </div>
